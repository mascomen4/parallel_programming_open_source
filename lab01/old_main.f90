include "lab01/src/matrix_multiplication.f90"
...
program test_matmul
    ...
    open(10, file='../lab01/data/A.csv', access='sequential', form="formatted")
    open(11, file='../lab01/data/B.csv', access='sequential', form="formatted")
    open(12, file='../lab01/data/C.csv', access='sequential', form="formatted")
    ...
    print * , all(C == naive_matmul(A, B))
    print * , all(Z == naive_matmul(X, Y))

    print * , all(C == block_matmul(A, B))
    print * , all(Z == block_matmul(X, Y))
